...
expName = 'tutorial3.0'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\dell\\Desktop\\MONSOON 2022\\PSY310 Lab in Psych\\Psychopy tutorial videos\\tutorial3.0_lastrun.py',
...
for thisTrial in trials:
    ...
    for i in range(num_distr):
        ...
        distr = visual.TextStim(win=win, name='distr',
            text='L',
            font='Open Sans',
            pos=(random()-0.5, random()-0.5), height=0.06, wrapWidth=None, ori=randint(0,360), 
            color='white', colorSpace='rgb', opacity=None, 
            languageStyle='LTR',
            depth=0.0);
